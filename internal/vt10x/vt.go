...
type Terminal interface {
	...
	// SetScrollCallback registers fn, called with the lines pushed off the top
	// of the normal screen (what a real terminal sends to scrollback).
	SetScrollCallback(fn func(lines [][]Glyph))
}
